...
Usage:  python3 vehicle_e2e.py [--addr localhost:8884] [--blueprint Vehicles/BMP2/BMP2]
...
from mapeditor_e2e import cdp_eval, enter_game, fresh_guid, wait_for_editor, VU_CDP_PY  # noqa: E402
