...
/*
    ...
    Additions by Powback

 */

// Toggler

UI.Toggler = function (open = false) {
...
UI.Toggler.prototype = Object.create( UI.Element.prototype );
UI.Toggler.prototype.constructor = UI.Toggler;

// Icon

UI.Icon = function ( iconName) {

    UI.Element.call( this );

    var dom = document.createElement( 'i' );

    dom.className = 'Icon Icon-' + iconName;
