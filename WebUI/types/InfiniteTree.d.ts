...
declare namespace InfiniteTree {
	...
	function addChildNodes(newNodes: Node[], index: number, parentNode: Node): boolean;
	...
	// @param {Node} parentNode The Node object that defines the parent node.
	// @return {boolean} Returns true on success, false otherwise.
	function appendChildNode(newNode: ITreeNode, parentNode: Node): boolean;
	...
	function checkNode(node: ITreeNode, checked: boolean): true;
	...
	// @return {boolean} Returns true on success, false otherwise.
	function closeNode(node: ITreeNode, options: object): boolean;
	...
	// }, filterOptions);
	function filter(predicate: any, options: object): void;
	...
	function flattenChildNodes(parentNode: Node): ITreeNode[];
	...
	function flattenNode(node: Node): ITreeNode[];
	...
	// @return {array} Returns an array of Node objects containing all the child nodes of the parent node.
	function getChildNodes(parentNode: Node): ITreeNode[];
	...
	function getNodeById(id: string): ITreeNode;
	...
	// @return {boolean} Returns true on success, false otherwise.
	function insertNodeAfter(newNode: ITreeNode, referenceNode: Node): boolean;

	// Inserts the specified node before the reference node.
	// @param {object} newNode The new sibling node.
	// @param {Node} referenceNode The Node object that defines the reference node.
	// @return {boolean} Returns true on success, false otherwise.
	function insertNodeBefore(newNode: ITreeNode, referenceNode: Node): boolean;

	// Loads data in the tree.
	// @param {object|array} data The data is an object or array of objects that defines the node.
	function loadData(data: any): void;
	...
	// @param {number} [index] The 0-based index of where to insert the child node.
	// @return {boolean} Returns true on success, false otherwise.
	function moveNodeTo(node: ITreeNode, parentNode: ITreeNode, index: number): boolean;
	...
	// @return {boolean} Returns true on success, false otherwise.
	function openNode(node: ITreeNode, options?: object): boolean;
	...
	// @return {boolean} Returns true on success, false otherwise.
	function removeChildNodes(parentNode: ITreeNode, options?: object): boolean;
	...
	// @param {boolean} [options.silent] Pass true to prevent "selectNode" event from being triggered.
	// @return {boolean} Returns true on success, false otherwise.
	function removeNode(node: ITreeNode, options: object): boolean;

	// Sets the current scroll position to this node.
	// @param {Node} node The Node object.
	// @return {boolean} Returns true on success, false otherwise.
	function scrollToNode(node: Node): boolean;
	...
	function scrollTop(value: number): number;
	...
	// @return {boolean} Returns true on success, false otherwise.
	function selectNode(node: ITreeNode, options?: object): boolean;

	// Swaps two nodes.
	// @param {Node} node1 The Node object.
	// @param {Node} node2 The Node object.
	// @return {boolean} Returns true on success, false otherwise.
	function swapNodes(node1: ITreeNode, node2: ITreeNode): boolean;
	...
	// @return {boolean} Returns true on success, false otherwise.
	function toggleNode(node: ITreeNode, options?: object): boolean;
	...
	function toString(node?: ITreeNode | null): string;
	...
	function updateNode(node: ITreeNode, data: any, options?: object): boolean;
}
